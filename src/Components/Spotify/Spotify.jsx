        ...
        <div className="Spotify-Container">
          ...
          <nav>
            <div className="Side-Nav-Bar">
                ...
                <div className="Menu">
                  <div className="Home">
                    <div className="Home-logo">
                      <GrHomeRounded fill="white" size={25} />
                    </div>
                    <div className="Home-Title">Home</div>
                  </div>
                  <div className="Search">
                    <div className="Search-logo">
                      <BsSearch fill="white" size={25} />
                    </div>
              ...
              <div className="Create-Play">Create Playlist</div>

              <div className="Liked">Liked Songs</div>
              <div className="">My Playlist #2</div>
              <div className="">My recommendation playlist</div>
