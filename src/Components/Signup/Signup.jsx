        ...
        <div className="Signup-Box">
          ...
          <form action="">
            <div className="Email-Container">
              <div className="Email-Title"> Whats's your email?</div>
              <input
          ...
          <div className="Password-container">
            <div className="Password-Title">Create a password</div>
            <input
              className="Text-Input"
              type="text"
          ...
          <div className="Username-container">
            <div className="Username-Title">What should we call you?</div>
            <input
              className="Text-Input"
              type="text"
          ...
          <div className="Gender-container">
            <div className="Gender-Title">What's your gender?</div>
            ...
            <div className="Msg-Box">
              <label htmlFor="">
                <input type="checkbox" />I would prefer not to recerive
                marketing messages form Spotify.
              </label>
            </div>
            <div className="Data-permission">
              <label htmlFor="">
                <input type="checkbox" />
                Share my registration data and usage data with Spotify's content
                providers for marketing purposes.
              </label>
            </div>
            <div className="TAC">
              By clicking Sign up, you agree to Spotify's
              <span className="Tac-span">Terms and Conditions of Use.</span>
            </div>
            <div className="Privacy-Policy">
              To learn more about how Spotify collects, uses, shares and
              protects your personal data please see.
              <span className="Policy">Spotify's Privacy Policy.</span>
            </div>
